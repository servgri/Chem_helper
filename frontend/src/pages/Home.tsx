  ...
  return (
    <div className="bg-grid min-h-screen font-sans">
      ...
      <main className="mx-auto max-w-6xl px-4 pb-16 font-sans">
        ...
        {/* Two cards: search | formula preview — full main width like Ketcher, equal height */}
        <section className="grid w-full grid-cols-2 items-stretch gap-3">
