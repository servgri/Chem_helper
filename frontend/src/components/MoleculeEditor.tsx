        ...
        <Ed
          ...
          onInit={(ketcher: any) => {
            ...
            try {
              ...
              /* Ketcher versions differ; polling below covers the rest */
            }
            const timerKey = "__toxmolTimer";
            if (ketcher[timerKey]) {
              window.clearInterval(ketcher[timerKey]);
            }
            ketcher[timerKey] = window.setInterval(() => {
